...
\begin{resume_section}{Skills}
  ...
  \textbf{Languages:}  \= Python, C, Scheme(Racket), HTML, CSS, LaTeX \\*
  \textbf{Tools:} \> Flask, ExpressJS, Selenium, Tkinter, Git, Linux, Vim/NeoVim, VSCode, SSH, Bash, VirtualBox/VMware \\*
  \end{nospacetabbing}
...
\begin{resume_section}{Experiences}
  \begin{resume_employer}{Speaker of Student Parliament}{Bodwell High School}{North Vancouver, BC}{02/2022 - 06/2022}
    \item Led and managed all meetings that the Parliament conducts (Team of 24).
