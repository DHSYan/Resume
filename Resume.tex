...
\begin{resume_section}{Skills}
  ...
  \textbf{Languages:}  \= C/C++, Python, Rust, Scheme(Racket), MMIX(Assembly Like), HTML/CSS, LaTeX \\*
  \textbf{Tools:} \> Flask, ExpressJS, Selenium, Tkinter, Git/GitHub, Linux, Vim, OS, Bash, DevOps, CI/CD, Testing\\* 
