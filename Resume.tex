...
\begin{resume_section}{Experiences}
  \begin{resume_employer}{English Teacher}{Team Alpha}{Taichung, Taiwan}{07/2020}

    \item Motivated 50+ students' interests in learning English, and help build their confidence in conversations.
...
\begin{resume_section}{Skills}
  \begin{nospacetabbing}
      ...
      \textbf{Communication:} \= Public Speaking, Teaching, Tutoring, Learning \\*
      \textbf{Languages:} \> English (Fluent) \& Mandarian (Fluent) \\*
      \textbf{Tools:} \> Word, PowerPoint, Excel, Windows, MacOS  \\
...
\begin{resume_section}{Education}
  \begin{resume_subsection}[07/2022 - Present]{University of Waterloo}
    \begin{nospacetabbing}
      ...
      \textbf{Courses:} \>Advanced Data Structures \& Algorithm, Advanced Designing Functional Programs, \\*\> Tools and Techniques for Software Development, Linear Algebra 1, Calculus 1\&2 \\*
