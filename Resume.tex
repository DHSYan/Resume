...
\begin{resume_section}{Skills}
  ...
  \textbf{Languages:}  \= Javascript/Typescript, C, Python, Rust, Scheme(Racket), MMIX(Assembly Like), HTML/CSS, LaTeX \\*
  \textbf{Tools:} \> React, NextJS, Flask, ExpressJS, Selenium, Nix/NixOS, Git/GitHub, Linux, Vim, Bash, Testing\\* 
...
\begin{resume_section}{Projects}
  \begin{resume_subsection}[]{\href{}{PRIMPL Assembler, SIMPL Compiler}}
   \begin{subitems}
    ...
    \item Understood and applied the knowledge of the stack, the heap, stack frames, stack and frame pointers.
    \end{subitems}
  ...
  % \begin{resume_subsection}[]{\href{https://github.com/TwinkletoesZen/.dotfiles}{Terminal Chat App}}
  %   \begin{subitems}
  %       \item Engineered a Terminal Chat App using C, TCP, UDP, Sockets, Threads
  %       \item Some but not all of the functionility of the app include, private messaging, boardcast messaging and media transfer.
  %       \item Acquired skills of multi-threaded programming, network programming and low-level programming
  %   \end{subitems}
  % \end{resume_subsection}


  \begin{resume_subsection}[]{\href{https://github.com/TwinkletoesZen/nix-config}{Nix Config; Infrastructure as Code\faGithub}}
    \begin{subitems}
    \item Developed declarative, reproducible Nix configurations using functional programming principles to ensure identical OS setups across systems.
    \item Implemented infrastructure as code to automate complete system rebuilds, eliminating manual provisioning and saving 100\% of setup time.
    \item Achieved consistent, error-free deployments by leveraging reproducible code, ensuring uniform system environments across diverse platforms.
    \item Acquired deep understanding of Linux systems by daily driving NixOS.
    \end{subitems}
  \end{resume_subsection}
