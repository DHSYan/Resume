...
\begin{resume_section}{Projects}
  ...
  \begin{resume_subsection}[]{\href{https://github.com/TwinkletoesZen/Personal-Website}{Personal Website \faGithub}}
    \begin{subitems}
      ...
      \item Acquired skills in basic front-end UI/UX design, such as CSS concepts and Flexbox.
    \end{subitems}
  \end{resume_subsection}
  ...
  \begin{resume_subsection}[]{\href{https://github.com/TwinkletoesZen/Password-Manager}{Password Manager \faGithub}}
    \begin{subitems}
      ...
      \item Independently improved the program over time by adopting version control, simple OOP designs, and documentation, developed problem-solving and analytical skills.
    \end{subitems}
  \end{resume_subsection}
